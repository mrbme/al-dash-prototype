...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { body: @widget.body, caption: @widget.caption, description: @widget.description, headline: @widget.headline } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { body: @widget.body, caption: @widget.caption, description: @widget.description, headline: @widget.headline } }
